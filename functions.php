<?php
/**
 * Jays functions and definitions
 *
...
if ( ! function_exists( 'jays_setup' ) ) :
	...
	function jays_setup() {
		 ...
		 * If you're building a theme based on Jays, use a find and replace
		 * to change 'jays' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'jays' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'jays_custom_background_args', array(
...
add_action( 'after_setup_theme', 'jays_setup' );
 ...
 */
function jays_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'jays_content_width', 640 );
}
add_action( 'after_setup_theme', 'jays_content_width', 0 );
 ...
 */
function jays_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'jays' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'jays' ),
...
add_action( 'widgets_init', 'jays_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'jays_scripts' );
